...
const editButton = async () => {
  await updateLink(props.selectedButton.id, props.selectedButton as LinkUpdate)
  props.onClose()
}
</script>
            ...
            >
              ...
              <div class="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <div v-if="selectedButton.social_platform" class="flex items-center gap-2 mt-2">
                    <component
                      :is="SOCIAL_PLATFORMS[selectedButton.social_platform]?.icon"
                      class="w-5 h-5 text-emerald-500"
                    />
                    <span class="text-gray-900 dark:text-gray-100 font-medium">
                      {{
                        SOCIAL_PLATFORMS[selectedButton.social_platform]?.name ||
                        selectedButton.social_platform
                      }}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="relative mt-1">
                    <input
                      type="url"
                      v-if="selectedButton.social_platform"
                      v-model="selectedButton.url"
                      :placeholder="
                        SOCIAL_PLATFORMS[selectedButton.social_platform]?.placeholder ||
                        'https://...'
                      "
                ...
                <div class="flex items-center justify-between">
                  ...
                  <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" class="sr-only peer" v-model="selectedButton.is_active" />
                    <div
